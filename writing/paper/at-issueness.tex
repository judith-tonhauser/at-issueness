...
Subsequent work shows that the `asking whether' diagnostic can nonetheless detect fine-grained differences. \citet{degen_projection_2025} found fine-grained at-issuness differences among the contents of the complements of 20 clause-embedding predicates in English. \Cref{fig:dtglossa} shows the mean `asking whether' ratings for the 20 predicates used in their study, ordered by mean rating. 
\begin{figure}[h]
  \centering
...
Each of the seven contents in \ref{stims} was realized as one of the seven items in \ref{items} in each of the four experiments.
...
Both experiments measured at-issueness of the contents of the complements of the 20 clause-embedding predicates from \citealt{degen_projection_2025}, which were shown in \Cref{fig:dtglossa}.
...
Target stimuli in both experiments were constructed by combining each of the 20 clause-embedding predicates in \ref{ex:predicates} with one of 20 items (see Supplement \ref{supp:a-clauses}). The same six control stimuli were included in both experiments. The contents targeted in these controls (see Supplement \ref{supp:control56}) were expected to be at-issue and served as attention checks.
...
A central empirical generalization emerging from our experiments is that diagnostics differ systematically in the degree of by-content differentiation they yield depending on how the target content is embedded. Diagnostics that present target contents in declarative sentences show reduced differentiation, whereas diagnostics using polar questions show greater differentiation. This raises the question of why the embedding context should have such a strong effect on diagnostic outcomes.

We hypothesize that this pattern reflects a ceiling effect in assertion-based diagnostics, driven by how different speech acts relate propositional content to speaker commitment. We assume that the declaratives in these diagnostics are interpreted as assertions, which involve speaker commitment to the truth of the at-issue content, whereas the polar questions are interpreted as information-seeking questions, which do not involve speaker commitment. The illocutionary force of the embedding utterance therefore determines how the at-issue main clause content relates to speaker commitments. Because content that is less at-issue is more (likely to be) projective (\citealt{tonhauser_how_2018,degen_projection_2025}), it is therefore associated with speaker commitments. As a result, the relationship to speaker commitments of not-at-issue content differs more sharply from the at-issue main clause content in polar questions than in assertions.

To illustrate this key contrast consider a polar question like \Next, where the at-issue content determines the set of alternatives under consideration \Next[a], but the speaker is not committed to any of these alternatives. In contrast, content that is (more) not-at-issue, like the NRRC content in \Next[b], is more likely to project, that is treated as true throughout the context set, and is therefore part of the speaker's commitments \citep{abusch_presupposition_2010,simons_what_2010,abrusan_predicting_2011,tonhauser_how_2018,degen_projection_2025}. 
...
We propose that this difference in epistemic contrast could affect how participants identify at-issue content in experimental tasks. Diagnostics of at-issueness require participants to evaluate which content an utterance is primarily about. In assertions, the at-issue main clause content is the content to which the speaker is committed. Participants may therefore use speaker commitment as a cue for identifying the main point of the utterance. However, not-at-issue content, such as appositive material, is also typically treated as part of the speaker's commitments, due to projection. As a result, both at-issue and not-at-issue content satisfy the same criterion: they are contents the speaker is committed to. We suggest that this similarity makes the two types of content harder to distinguish in assertion-based diagnostics. This would lead to not-at-issue content being rated more similarly to at-issue content, giving rise to overall higher ratings for not-at-issue content and reduced differentiation across contents, essentially creating a ceiling effect.

This reduction in contrast does not arise in polar questions: Although the not-at-issue content of polar questions is also associated with speaker commitment due to projection, their at-issue content is not. As a result, speaker commitment cannot be used as a cue for identifying the main point of the utterance in questions, and interpreters must rely on other aspects of the utterance instead. Here, not-at-issue content is not rated more similarly to at-issue content, and the epistemic contrast between the two types of content is preserved, allowing for greater differentiation. On this view, polar questions do not so much enhance differences as leave them visible, whereas assertions tend to mask them.

Importantly, this hypothesis does not depend on the target content being clearly not-at-issue, as in the case of appositive NRRCs, but it predicts that assertion-based diagnostics can obscure more subtle differences in at-issueness as well. For contents whose status is less clearly determined by conventional meaning, such as complements of verbs like \emph{discover} or \emph{reveal}, reduced epistemic contrast in assertions may compress differences between at-issue and not-at-issue content as well. In the context of a diagnostic, the utterance of a declarative sentence \Next signals that speaker is committed to the main clause at-issue content \Next[b], and we would be diagnosing the at-issueness of the target content \Next[a].
...
Now, if \Last[a] (\textsf{p}) is interpreted as more at-issue, then at-issueness ratings will be higher. If \textsf{p} is interpreted as less at-issue, at-issueness ratings should in principle be lower, but here, ratings for less at-issue content could be inflated due to projection and speaker commitment. If \textsf{p} is (more) not-at-issue, it is also more likely to project, leading to speaker commitment (\citealt{tonhauser_how_2018,degen_projection_2025}). Under a gradient view of at-issueness, we could, for instance, articulate this in terms of the gradient projection principle (\citealt{tonhauser_how_2018}), which suggests that the more at-issue it is, the more projective it also is, and thus, the more associated with speaker commitment. In turn, the more a content is associated with speaker commitment, the harder it is to distinguish from the at-issue main clause in assertions. 
...
These definitions differ in their theoretical grounding, and the literature differs in how this difference should be interpreted. One possibility is that they characterize different perspectives on a single underlying phenomenon (e.g., \citealt{tonhauser_diagnosing_2012,anderbois_at-issue_2015,faller_discourse_2019}). On this view, diagnostics may differ in implementation, but they should ultimately pattern together to the extent that they probe the same discourse property. Another possibility is that the two definitions characterize two different underlying phenomena (\citealt{koev_notions_2018}). On this view, at least some diagnostic differences should reflect this theoretical divide. A third possibility is that some apparent diagnostic differences do not track different notions of at-issueness at all, but instead arise because certain diagnostics are sensitive to other properties, such as propositional anaphoric availability (\citealt{snider_anaphoric_2017,snider_at-issueness_2017,snider_distinguishing_2018,korotkova_evidential_2020}).
