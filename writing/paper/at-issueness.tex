...
This finding can be understood if we assume that participants are better able to distinguish at-issue from not-at-issue content when these two contents have more distinct pragmatic roles, and questions provide an environment where that is the case. We hypothesize the relevant contrast lies in how at-issue and not-at-issue content relate to speaker commitments: In assertions, but not in questions, the speaker commits to the truth of the at-issue proposition. Not-at-issue content, in contrast, projects and thus contributes to speaker commitment regardless of speech act (see \citealt{potts_logic_2005,abusch_presupposition_2010,simons_what_2010,abrusan_predicting_2011,tonhauser_how_2018,degen-tonhauser-glossa}). As a result, at-issue and not-at-issue content are pragmatically more distinct in questions, making it easier for participants to distinguish the two levels of meaning. Embedding target content in questions therefore allows for detection of more fine-grained differences in at-issueness associated with the conventional meaning of particular expressions, whereas assertions introduce a confounding factor: the speaker commits to both levels of content, reducing differentiation in at-issueness judgments.
  ...
  \subsection{methodological implications  \label{ssec:discussion-methodological}}
      An implication is that future research should take into account that results may only be due to the speech act, particular response task used, other discourse factors,  empirical investigations should continue path of using multiple diagnostics 

      Therefore, future research on at-issueness should carefully consider the speech act context in which target contents are presented, as this can significantly impact the results of at-issueness diagnostics.
