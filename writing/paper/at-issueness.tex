...
% \jt{do K\&P rely on the concept? why is the Chen thesis cited? It's not very prominent or old; same for S\&P 2025. I don't see Abbott or H\&H using the term at-issueness. Why are they included? For ps, I think Simons et al 2010 and T et al 2018 are enough.} \lh{You added the K\&P reference here, and others about presupposition, not me. I did add the Chen reference, because we were already citing it anyways later on, and you had asked to add more references for the tests in the introduction. So I thought it might be good to add a few more here, as well. But maybe you don’t mean this as a question, but as a suggestion? I have removed the presupposition references then other than the ones you mentioned.}
%
...
\begin{table}[h!]
  ...
  \begin{tabular}{l | r r | r r r | r }
    ...
    Exp.~6 (direct response)    &  5 &  24 & 18-58 (24.9) & 187/28/5/0 & 220 & 5720 \\ 
    \hline
  \end{tabular}}
...
This paper reported the results of six experiments designed to investigate whether at-issueness  diagnostics yield consistent results when applied to the same target contents. Exps.~1--4 show that, as implemented, the diagnostics do not converge,\jt{Is ``they do not converge'' an answer to the research question of whether the diagnostics yield consistent results? I think something like ``no, they don't yield consistent results'' is more on point?} suggesting that they are not interchangeable.\jt{i think that this adverbial clause is a great methodological implication that deserves more attention than it is given here. Also, why does this paragraph only mention Exps 1-4, and not also 5-6? i think that's because 5-6 address a different research question, namely which diagnostic shows the greatest differentiation between contents and why? If you agree, then that research question also needs to be motivated in section 1}
...
We suggest that the lower by-content differentiation observed in diagnostics that embed target content in assertions,\jt{at the very least, the paper should state clearly that we assume, following XY, that declaratives typically have the illocutionary force of assertions and interrogatives that of information-seeking questions} compared to polar questions, may reflect a ceiling effect in assertion-based diagnostics. We hypothesize that this could result from how the illocutionary force of assertions relates propositional content to speaker commitment in different ways: in assertions, but not in questions, the speaker commits to the truth of the at-issue main clause content.
...
\b. $\Rightarrow$\jt{what does this arrow mean? entailment? speaker commitment? perhaps use words instead?} \emph{Greg bought a car.} \hfill (not-at-issue content)
\z. \z. 
...
Now, if \Last[a] (\textsf{p}) is interpreted as more at-issue, then participants will give responses that are consistent with this more at-issue interpretation.\jt{i don't understand this sentence: the antecedent of the conditional and the consequent seem to say the same thing?} If \textsf{p} is interpreted as less at-issue, construe \textsf{q} as the primary at-issue contribution. In this case, asserting $\textsf{q}:$ \emph{Helen confirmed} \textsf{p} also leads the speaker to commit to the target content \textsf{p}.\jt{why? the CC is not entailed} As a result, the supposed not-at-issue content \textsf{p} would be similar in its epistemic status to the at-issue main clause content \textsf{p}, because the speaker is committed to both, which could make them harder to distinguish. The epistemic status of the at-issue main clause content and not-at-issue content is therefore highly similar in assertions.
...
Because the diagnostics are grounded in distinct assumptions about what it means for content to be at-issue, the observed differences between diagnostics also bear on the broader question of whether existing diagnostics track a common underlying notion of at-issueness or operationalize distinct phenomena. While many of the diagnostic differences in our data find plausible explanations in methodological and contextual factors,\jt{which ones? I remember the ``be right'' discussion and the discussion about final and medial NRRCs. were there others, to make ``many''? and I'd rather not frame them as explanations but as hypotheses} we found no obvious empirical split between QUD-at-issueness and proposal at-issueness.\jt{what underlies this needs to be spelled out. I don't think the paper has made the explicit anywhere?} This section considers what our results suggest for this issue.
