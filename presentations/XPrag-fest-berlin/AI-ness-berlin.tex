...
\section{Introduction}
	\begin{frame}[t]\frametitle{Different at-issueness diagnostics}\scriptsize
		...
		\begin{itemize}
			...
			\item Diagnostics sensitive to a notion of at-issueness relative to the QUD, based on \citealt{amaral_review_2007,simons_what_2010}
			\item Conceptual differences: at-issueness relative to QUD or relative to assertive proposal (\citealt{snider_anaphoric_2017,snider_at-issuenessne_2017,snider_distinguishing_2018,koev_notions_2018,faller_discourse_2019,korotkova_evidential_2020})
		\end{itemize}
