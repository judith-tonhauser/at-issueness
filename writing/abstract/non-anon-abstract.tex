...
\begin{figure}[htbp]
  ...
  \subfloat[Answer match ratings for the QUD-diagnostic]{
        \includegraphics[width=.48\textwidth]{img/mean-QUD-ratings.pdf}
        \label{fig:qud}
    }
    \subfloat[`asking whether' ratings]{
        \includegraphics[width=.48\textwidth]{img/mean-AK-ratings.pdf}
        \label{fig:AK}
    }\\
    \vspace{-\baselineskip}
    \subfloat[Naturalness ratings for the `direct dissent' diagnostic]{
        \includegraphics[width=.48\textwidth]{img/mean-DD-ratings.pdf}
        \label{fig:dd}
    }
