...
\section{Introduction}
	\begin{frame}\frametitle{At-issueness}\small
		...
		\begin{itemize}
			...
			\phantom. \hfill 
			{\scriptsize e.g., 
			(\citealt{snider_anaphoric_2017,snider_at-issuenessne_2017,snider_distinguishing_2018,tonhauser_how_2018,koev_notions_2018,faller_discourse_2019,korotkova_evidential_2020})}\pause
...
\section{Experiments 1–4}
	...
	\begin{frame}[t]\frametitle{Question-based at-issueness diagnostics}
		...
		\visible<3->{\begin{itemize}
			...
			\phantom.\hfill {\scriptsize(\citealt{snider_anaphoric_2017,snider_at-issuenessne_2017,snider_distinguishing_2018,koev_notions_2018,faller_discourse_2019,korotkova_evidential_2020})}
		\end{itemize}}
