...
We can understand the ill-formedness of \Last within a QUD-based framework of discourse structure (\citealt{ginzburg_interrogatives_1996,roberts_information_2012,buring_d-trees_2003}). In this framework, the contextual requirement of \emph{be right}, that a prior commitment be salient in the discourse, will result in a requirement that the QUD addressed by the act of making this commitment must be part of the QUD stack. Specifically, in \Last, Danny's commitment that \enquote{Lucy broke the plate} addresses the QUD (or sub-QUD) \enquote{whether Lucy broke the plate}. This means that the question \enquote{Whether Lucy broke the plate} must be part of the QUD stack at the point where \emph{be right} is uttered.
...
To illustrate this key contrast, consider a polar question like \Next, where the at-issue content determines the set of alternatives under consideration \Next[a], but the speaker is not committed to any of these alternatives. In contrast, not-at-issue content, like the NRRC content in \Next[b], is more likely to project, that is, more likely to be treated as true throughout the context set, and therefore as part of speaker commitments \citep{abusch_presupposition_2010,simons_what_2010,abrusan_predicting_2011,tonhauser_how_2018,degen_projection_2025}. 
