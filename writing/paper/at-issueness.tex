...
\centering
\fbox{\includegraphics[width=1\textwidth]{figures/trialExp1}}
 \caption{Exp.~1: QUD diagnostic}
 \end{subfigure} 
 \begin{subfigure}{.49\textwidth}
\centering
\fbox{\includegraphics[width=1\textwidth]{figures/trialExp2}}
 \caption{Exp.~2: `asking whether' diagnostic}
 \end{subfigure}

\begin{subfigure}{.49\textwidth}
\centering
\fbox{\includegraphics[width=1\textwidth]{figures/trialExp3}}
 \caption{Exp.~3: `direct dissent' diagnostic}
 \end{subfigure} 
 \begin{subfigure}{.49\textwidth}
\centering
\fbox{\includegraphics[width=1\textwidth]{figures/trialExp4}}
