...
\section{Experiments \label{sec:2_experiments}}
  ...
  For each of the four experiments, we recruited 80 participants on Prolific. These participants had registered on the platform as monolingual native speakers of English who lived in the USA. They had at least 100 previous submissions and an approval rate of at least 97\%.
  ...
  \Cref{fig:results} shows the mean responses by content for the four diagnostics. Comparing the results across diagnostics reveals some key differences.
